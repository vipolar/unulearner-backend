...
public class StorageTaskUploadFile extends StorageTask {
    public StorageTaskUploadFile(StorageTree storageTree, StorageTreeNode targetNode, StorageTreeNode destinationNode, StorageTasksMap storageTasksMap) {
