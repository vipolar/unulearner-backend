...
public class Handler { /* TODO: the whole thing might need rework! */
    ...
    public void setOnExceptionAction(StorageNode storageNode, String exceptionType, String exceptionAction, Boolean setOnExceptionActionAsDefault) {
    ...
    public String getOnExceptionAction(StorageNode storageNode, String exceptionType) throws IllegalArgumentException {
